...
public class PicnicDAO implements PicnicDAO_interface {
	...
	private static final String GET_ALL_SL_STMT = "select PICNIC_NO,PICNIC_NAME,PICNIC_DESC,PICKUPDATE,PICNIC_STARTUP,PICNIC_SETUP,PICNIC_CHK,PICNIC_DATE,PICNIC_PL,PICNIC_STA,ORD_TOTAL,ORD_DATE,ORD_DM,ORD_STA FROM PICNIC WHERE PICNIC_STA in ('S', 'L', 'F') Order by PICNIC_NO";
