...
<%
	ManufacturersVO MfVO = (ManufacturersVO) request.getAttribute("MfVO");
%>
...
<body>
	...
	<form METHOD="post" ACTION="Manufacturers.do" name="form1"
						...
						<ul class="list-group">
							<li class="list-group-item">
								...
								<div class="col-xs-12 col-sm-8">
									<input type="text" name="MF_ACCO" id="MF_ACCO"
										placeholder="請輸入帳號" style="width: 200px;"
										value="<%=(MfVO == null) ? "" : MfVO.getMF_ACCO()%>">
									<font color='red' id="ACCO"><b>${errorMsgs.MF_ACCO}</b></font>
									<font color='red'><b>${errorMsgs.MF_ACCO_1}</b></font>
								</div>
							</li>
							<li class="list-group-item">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<input type="password" name="MF_PSW" id="MF_PSW"
											...
											value="<%=(MfVO == null) ? "" : MfVO.getMF_PSW()%>">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<input type="text" name="MF_MAIL" id="MF_MAIL"
											...
											value="<%=(MfVO == null) ? "" : MfVO.getMF_MAIL()%>">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<input type="text" name="MF_PHONE" id="MF_PHONE"
											...
											value="<%=(MfVO == null) ? "" : MfVO.getMF_PHONE()%>">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<input type="text" name="MF_NAME" id="MF_NAME"
											placeholder="請填寫廠商名稱"
											value="<%=(MfVO == null) ? "" : MfVO.getMF_NAME()%>">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<input type="text" name="MF_FAX" id="MF_FAX"
											value="<%=(MfVO == null) ? "" : MfVO.getMF_FAX()%>">
									</div>
								</div>
							</li>
							<li class="list-group-item">
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<input type="text" name="MF_ADDR" id="MF_ADDR"
											style="width: 300px;"
											value="<%=(MfVO == null) ? "" : MfVO.getMF_ADDR()%>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<input type="text" name="MF_BS" id="MF_BS"
											value="<%=(MfVO == null) ? "" : MfVO.getMF_BS()%>"> <font
											color='red' id="BS"><b>${errorMsgs.MF_BS}</b></font> <font
											color='red'><b>${errorMsgs.MF_BS_1}</b></font>
									</div>
								</div>
							</li>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-4">
										<input type="file" name="MF_LOGO" size="45" class="upl"
											value="<%=(MfVO == null) ? "" : MfVO.getMF_LOGO()%>" />
									</div>
									<div class="col-xs-12 col-sm-4">
										<img class="preview"
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-8">
										<textarea rows="7" cols="50" name="MF_SELF" id="MF_SELF"
											value="<%=(MfVO == null) ? "" : MfVO.getMF_SELF()%>"></textarea>
									</div>
								</div>
							</li>
							<li class="list-group-item">
		...
		<input type="hidden" name="MF_REPORTNUM" size="45"
			value="<%=(MfVO == null) ? 0 : MfVO.getMF_REPORTNUM()%>" /> <input
			type="hidden" name="MF_STA" size="45"
			value="<%=(MfVO == null) ? "U" : MfVO.getMF_STA()%>" /> <input
	...
	<script>
		...
		function add() {
			...
			//驗證email
			var email = document.getElementById('MF_MAIL').value;
			var emailRegxp = /^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z]+$/;

			//驗證phone

			var phone = document.getElementById("MF_PHONE").value;
			var phonetest = /^09[0-9]{8}$/;

			if (document.getElementById("MF_ACCO").value.length < 8) {
				document.getElementById("MF_ACCO").focus();
				document.getElementById("MF_ACCO").select();
				document.getElementById("ACCO").innerText = "*請輸入八個字以上";

			} else if (document.getElementById("MF_PSW").value.length < 8) {
			...
			} else if (document.getElementById("MF_PSW").value != document
					.getElementById("MF_PSW_1").value) {
				alert("密碼輸入錯誤");
			...
			} else if (document.getElementById("MF_NAME").value == '') {
				// 				alert("請輸入廠商名稱");
