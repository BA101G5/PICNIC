...
<%
    Blocked_KeywordsDAO dao = new Blocked_KeywordsDAO();
...
<html>
<head>
<title>所有最新消息資料 - listAllBlocked_Keywords1_byDAO.jsp</title>
</head>
<body bgcolor='white'>
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		<td>
		<h3>所有最新消息資料 - listAllBlocked_Keywords1_byDAO.jsp</h3>
