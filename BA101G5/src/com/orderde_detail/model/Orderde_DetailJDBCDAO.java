...
public class Orderde_DetailJDBCDAO implements Orderde_Detail_interface {
	...
	public void update(Orderde_DetailVO orderde_detailVO) {
		...
		try {
			...
			pstmt.setString(1, orderde_detailVO.getP_no());
			pstmt.setString(2, orderde_detailVO.getGr_no());
			...
			pstmt.setString(7, orderde_detailVO.getOd_bs());
			pstmt.setString(8, orderde_detailVO.getPicnic_no());
