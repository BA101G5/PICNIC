...
<script>
		...
		function add() {
			...
			if(document.getElementById('DAY_START').value == ''){
				document.getElementById('DAY_START').focus();
				document.getElementById('DAY_START').select();
					document.getElementById('START').innerText="*請輸入開始日期"; 
			}else if(document.getElementById('DAY_END').value == ''){
				document.getElementById('DAY_END').focus();
				document.getElementById('DAY_END').select();
