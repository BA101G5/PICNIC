...
<div class="container" style="background-color:white;height:80%;opacity:0.8;">
	<div class="row">
			...
			<div role="tabpanel" style="">
				...
				<div class="tab-content">
								...
								<tbody>
									<c:forEach var="GRVO" items="${GRSvc.all}">
										<c:if test="${mVO.MF_NO == GRVO.mf_no}">
											<form METHOD="post"	ACTION="<%=request.getContextPath()%>/goods_rent/goods_rent.do" enctype="multipart/form-data">
											<tr>
												<td><img
					...
					<div role="tabpanel" class="tab-pane active" id="tab4">
						...
						<div class="col-xs-12 col-sm-6" style="margin-top: 20px;margin-bottom: 40px;">
							${mVO.MF_SELF}</div>
					</div>
